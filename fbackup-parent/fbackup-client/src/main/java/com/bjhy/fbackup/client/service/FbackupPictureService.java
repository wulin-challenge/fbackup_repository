package com.bjhy.fbackup.client.service;
...
import com.bjhy.fbackup.client.core.domain.BaseInfoMedaiInfo;
...
import com.bjhy.fbackup.client.core.statics.LoaderYzDatasource;
import com.bjhy.fbackup.client.core.util.BaseInfoMedaiInfoUtil;
import com.bjhy.fbackup.client.core.util.InstanceUtil;
import com.bjhy.fbackup.client.util.ClientPictureUtil;
 ...
 */
@FBackupListener
public class FbackupPictureService implements FBackupClient{
	...
	private void scanningMediaData(BaseInfoMedaiInfo baseInfoMedaiInfo){
		checkAndStoreFile(DIRECTORY_TYPE_PICTURE, baseInfoMedaiInfo.getMediaInfoMturl());
	...
	private Boolean initLoaderYzDataSource(){
		directoryTypePicture = ClientPictureUtil.getPictureByStaticType(ConstantUtil.STATIC_TYPE);
